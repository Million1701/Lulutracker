...
const Card: React.FC<{ children: React.ReactNode; className?: string }> = ({
  children,
  className = '',
}) => <div className={`bg-white dark:bg-gray-800 shadow-lg ${className}`}>{children}</div>;
...
const Button: React.FC<{
  ...
  const variants = {
    primary: 'bg-blue-600 dark:bg-blue-500 text-white hover:bg-blue-700 dark:hover:bg-blue-600 active:scale-95',
    outline:
